...
namespace Server.Engines.Craft
{
	public class DefBowFletching : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			// Materials
			AddCraft( typeof( Kindling ), 1044457, 1023553, 0.0, 00.0, typeof( BaseLog ), 1044466, 1, 1044351 );

			index = AddCraft( typeof( Kindling ), 1044457, "batch of kindling", 0.0, 00.0, typeof( BaseLog ), 1044466, 1, 1044351 );
			SetUseAllRes( index, true );

			index = AddCraft( typeof( Shaft ), 1044457, 1027124, 0.0, 40.0, typeof( BaseLog ), 1044466, 1, 1044351 );
			SetUseAllRes( index, true );
