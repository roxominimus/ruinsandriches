...
namespace Server.Engines.Craft
{
	public class DefTailoring : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( HoodedMantle ), 1011375, "hooded mantle", 7.2, 32.2, typeof( Cloth ), 1044286, 12, 1044287 );
			...
			AddCraft( typeof( ScholarRobe ), 1015269, "scholar robe", 70.0, 95.0, typeof( Cloth ), 1044286, 16, 1044287 );
			...
			AddCraft( typeof( BigBag ), "Bags", "bag, big", 22.0, 47.0, typeof( Leather ), 1044462, 8, 1044463 );
