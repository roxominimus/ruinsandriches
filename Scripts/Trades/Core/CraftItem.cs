...
namespace Server.Engines.Craft
{
	...
	public class CraftItem
	{
		...
		public int EnchantItem( Item item, Mobile from, Type typeRes, CraftSystem craftSystem )
		{
			...
			if ( item is BaseClothing ){ cloth = 100; }

			if ( craftSystem == DefTinkering.CraftSystem ){ 		skill = (int)(from.Skills[SkillName.Tinkering].Value);		if ( pm.NpcGuild == NpcGuild.TinkersGuild ){ guild = 100; }		}
			else if ( craftSystem == DefTailoring.CraftSystem ){ 	skill = (int)(from.Skills[SkillName.Tailoring].Value);		if ( pm.NpcGuild == NpcGuild.TailorsGuild ){ guild = 100; }		}
			else if ( craftSystem == DefCarpentry.CraftSystem )
			{
				skill = (int)(from.Skills[SkillName.Carpentry].Value);
				if ( pm.NpcGuild == NpcGuild.CarpentersGuild ){ guild = 100; }
				else if ( pm.NpcGuild == NpcGuild.BardsGuild && item is BaseInstrument ){ guild = 100; }
			}
			else if ( craftSystem == DefBowFletching.CraftSystem ){ skill = (int)(from.Skills[SkillName.Bowcraft].Value);		if ( pm.NpcGuild == NpcGuild.ArchersGuild ){ guild = 100; }		}
			else if ( craftSystem == DefBlacksmithy.CraftSystem ){ 	skill = (int)(from.Skills[SkillName.Blacksmith].Value);		if ( pm.NpcGuild == NpcGuild.BlacksmithsGuild ){ guild = 100; }		}
			...
			switch ( thisResource )
			{
				case CraftResource.AshTree:			block = 7;		break;
				case CraftResource.CherryTree:		block = 14;		break;
				case CraftResource.EbonyTree:		block = 21;		break;
				case CraftResource.GoldenOakTree:	block = 28;		break;
				case CraftResource.HickoryTree:		block = 35;		break;
				case CraftResource.MahoganyTree:	block = 42;		break;
				case CraftResource.DriftwoodTree:	block = 49;		break;
				case CraftResource.OakTree:			block = 56;		break;
				case CraftResource.PineTree:		block = 63;		break;
				case CraftResource.GhostTree:		block = 70;		break;
				case CraftResource.RosewoodTree:	block = 77;		break;
				case CraftResource.WalnutTree:		block = 84;		break;
				case CraftResource.PetrifiedTree:	block = 91;		break;
				case CraftResource.ElvenTree:		block = 100;	break;

				case CraftResource.DullCopper:		block = 7;		break;
				case CraftResource.ShadowIron:		block = 14;		break;
				case CraftResource.Copper:			block = 21;		break;
				case CraftResource.Bronze:			block = 28;		break;
				case CraftResource.Gold:			block = 35;		break;
				case CraftResource.Agapite:			block = 42;		break;
				case CraftResource.Verite:			block = 49;		break;
				case CraftResource.Valorite:		block = 56;		break;
				case CraftResource.Nepturite:		block = 63;		break;
				case CraftResource.Obsidian:		block = 70;		break;
				case CraftResource.Steel:			block = 77;		break;
				case CraftResource.Brass:			block = 84;		break;
				case CraftResource.Mithril:			block = 91;		break;
				case CraftResource.Xormite:			block = 98;		break;
				case CraftResource.Dwarven:			block = 100;	break;

				case CraftResource.SpinedLeather:	block = 9;		break;
				case CraftResource.HornedLeather:	block = 18;		break;
				case CraftResource.BarbedLeather:	block = 27;		break;
				case CraftResource.NecroticLeather:	block = 36;		break;
				case CraftResource.VolcanicLeather:	block = 45;		break;
				case CraftResource.FrozenLeather:	block = 54;		break;
				case CraftResource.GoliathLeather:	block = 63;		break;
				case CraftResource.DraconicLeather:	block = 72;		break;
				case CraftResource.HellishLeather:	block = 81;		break;
				case CraftResource.DinosaurLeather:	block = 90;		break;
				case CraftResource.AlienLeather:	block = 100;	break;
			}
		...
		public void CompleteCraft( int quality, bool makersMark, Mobile from, CraftSystem craftSystem, Type typeRes, BaseTool tool, CustomCraft customCraft )
		{
			...
			if ( CheckSkills( from, typeRes, craftSystem, ref ignored, ref allRequiredSkills ) )
			{
				...
				if ( item != null )
				{
					...
					{
						if ( item is BaseWeapon || item is BaseArmor || item is BaseInstrument || item is BaseJewel || item is BaseHat || item is BaseQuiver || item is BaseClothing )
						{
							item = Server.LootPackEntry.Enchant( from, EnchantItem( item, from, typeRes, craftSystem ), item );
						}
					}
					...
					else if ( item is HorseArmor )
					{
						...
						switch ( thisResource )
						{
							case CraftResource.DullCopper: color = MaterialInfo.GetMaterialColor( "dull copper", "monster", 0 ); material = "Dull Copper"; break;
							case CraftResource.ShadowIron: color = MaterialInfo.GetMaterialColor( "shadow iron", "monster", 0 ); material = "Shadow Iron"; break;
							case CraftResource.Copper: color = MaterialInfo.GetMaterialColor( "copper", "monster", 0 ); material = "Copper"; break;
							case CraftResource.Bronze: color = MaterialInfo.GetMaterialColor( "bronze", "monster", 0 ); material = "Bronze"; break;
							case CraftResource.Gold: color = MaterialInfo.GetMaterialColor( "gold", "monster", 0 ); material = "Gold"; break;
							case CraftResource.Agapite: color = MaterialInfo.GetMaterialColor( "agapite", "monster", 0 ); material = "Agapite"; break;
							case CraftResource.Verite: color = MaterialInfo.GetMaterialColor( "verite", "monster", 0 ); material = "Verite"; break;
							case CraftResource.Valorite: color = MaterialInfo.GetMaterialColor( "valorite", "monster", 0 ); material = "Valorite"; break;
							case CraftResource.Nepturite: color = MaterialInfo.GetMaterialColor( "nepturite", "monster", 0 ); material = "Nepturite"; break;
							case CraftResource.Obsidian: color = MaterialInfo.GetMaterialColor( "obsidian", "monster", 0 ); material = "Obsidian"; break;
							case CraftResource.Steel: color = MaterialInfo.GetMaterialColor( "steel", "monster", 0 ); material = "Steel"; break;
							case CraftResource.Brass: color = MaterialInfo.GetMaterialColor( "brass", "monster", 0 ); material = "Brass"; break;
							case CraftResource.Mithril: color = MaterialInfo.GetMaterialColor( "mithril", "monster", 0 ); material = "Mithril"; break;
							case CraftResource.Xormite: color = MaterialInfo.GetMaterialColor( "xormite", "monster", 0 ); material = "Xormite"; break;
							case CraftResource.Dwarven: color = MaterialInfo.GetMaterialColor( "dwarven", "monster", 0 ); material = "Dwarven"; break;
						}
					...
					else if ( item is TrapKit )
					{
						...
						item is CherryArmoire )
						{
							...
							else if ( item is GiantBag ){ cHue = Server.Misc.MaterialInfo.PlainLeatherColor(); }
							else if ( item is LargeSack ){ cHue = Server.Misc.MaterialInfo.PlainLeatherColor(); }
							else if ( item is BigBag ){ cHue = Server.Misc.MaterialInfo.PlainLeatherColor(); }
