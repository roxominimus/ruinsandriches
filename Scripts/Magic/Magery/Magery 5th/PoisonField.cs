			...
			private class InternalTimer : Timer
			{
				...
				protected override void OnTick()
				{
					...
					if ( !m_Item.Visible )
					{
						...
						{
							m_Item.ProcessDelta();
							Effects.SendLocationParticles( EffectItem.Create( m_Item.Location, m_Item.Map, EffectItem.DefaultDuration ), 0x376A, 9, 10, Server.Misc.PlayerSettings.GetMySpellHue( true, m_Item.m_Caster, 0 ), 0, 5040, 0 );
						}
					}
