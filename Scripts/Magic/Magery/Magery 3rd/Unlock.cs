		...
		private class InternalTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object o )
			{
				...
				if ( m_Owner.CheckSequence() ) {
					...
					Effects.SendLocationParticles( EffectItem.Create( new Point3D( loc ), from.Map, EffectItem.DefaultDuration ), 0x376A, 9, 32, Server.Misc.PlayerSettings.GetMySpellHue( true, from, 0 ), 0, 5024, 0 );
