	...
	public class ManaVampireSpell : MagerySpell
	{
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckHSequence( m ) )
			{
				...
				m.FixedParticles( 0x374A, 1, 15, 5054, Server.Misc.PlayerSettings.GetMySpellHue( true, Caster, 23 ), 7, EffectLayer.Head );
				m.PlaySound( 0x1F9 );

				Caster.FixedParticles( 0x0000, 10, 5, 2054, Server.Misc.PlayerSettings.GetMySpellHue( true, Caster, 23 ), 7, EffectLayer.Head );
