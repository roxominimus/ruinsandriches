			...
			else if ( SpellHelper.CheckTown( p, Caster ) && CheckSequence() )
			{
				...
				if ( targets.Count > 0 )
				{
					...
					for ( int i = 0; i < targets.Count; ++i )
					{
						...
						Effects.SendLocationEffect( blast1, m.Map, Utility.RandomList( 0x33E5, 0x33F5 ), 85, 10, Server.Misc.PlayerSettings.GetMySpellHue( true, Caster, 0 ), 0 );
						Effects.SendLocationEffect( blast2, m.Map, Utility.RandomList( 0x33E5, 0x33F5 ), 85, 10, Server.Misc.PlayerSettings.GetMySpellHue( true, Caster, 0 ), 0 );
						Effects.SendLocationEffect( blast3, m.Map, Utility.RandomList( 0x33E5, 0x33F5 ), 85, 10, Server.Misc.PlayerSettings.GetMySpellHue( true, Caster, 0 ), 0 );
						Effects.SendLocationEffect( blast4, m.Map, Utility.RandomList( 0x33E5, 0x33F5 ), 85, 10, Server.Misc.PlayerSettings.GetMySpellHue( true, Caster, 0 ), 0 );
						Effects.SendLocationEffect( blast5, m.Map, Utility.RandomList( 0x33E5, 0x33F5 ), 85, 10, Server.Misc.PlayerSettings.GetMySpellHue( true, Caster, 0 ), 0 );
