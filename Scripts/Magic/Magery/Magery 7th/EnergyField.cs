		...
		public void Target( IPoint3D p )
		{
			...
			else if ( SpellHelper.CheckTown( p, Caster ) && CheckSequence() )
			{
				...
				for ( int i = -2; i <= 2; ++i )
				{
					...
					Effects.SendLocationParticles( EffectItem.Create( loc, Caster.Map, EffectItem.DefaultDuration ), 0x376A, 9, 10, Server.Misc.PlayerSettings.GetMySpellHue( true, Caster, 0 ), 0, 5051, 0 );
				}
			}
