...
namespace Server.Spells.Mystic
{
	public class QuiveringPalm : MysticSpell
	{
		...
		public override void OnCast()
		{
			...
			else if ( !( weapon is Artifact_GlovesOfThePugilist || weapon is GlovesOfThePugilist || weapon is GiftPugilistGloves || weapon is LevelPugilistGloves || weapon is PugilistGloves || weapon is PugilistGlove ) )
			{
				Caster.SendMessage( "You must be wearing some type of pugilist gloves!" );
			}
