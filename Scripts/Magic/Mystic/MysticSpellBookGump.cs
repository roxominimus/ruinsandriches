	...
	public class MysticSpellbookGump : Gump 
	{
		...
		public MysticSpellbookGump( Mobile from, MysticSpellbook book, int page ) : base( 100, 100 ) 
		{
			...
			else if ( page > 1 && page < 12 )
			{
				...
				string know = "<BODY><BASEFONT Color=#f58a8a>Not Learned</BASEFONT></BODY>"; if ( this.HasSpell( abil_spid ) ){ know = "<BODY><BASEFONT Color=#8af599>Learned</BASEFONT></BODY>"; }
				...
				if ( this.HasSpell( abil_spid) ){ abil_info = ""; showScrollBar = false; AddButton(78, 94, abil_icon, abil_icon, abil_spid, GumpButtonType.Reply, 0); }
