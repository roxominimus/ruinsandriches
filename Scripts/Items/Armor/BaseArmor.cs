		...
		public static void CheckMetalColor( BaseArmor armor )
		{
						...
						armor is ChainSkirt )
			{
				...
				if ( armor.Hue == 0 )
				{
					...
					else if ( armor.Resource == CraftResource.Iron ){ armor.Hue = Server.Misc.MaterialInfo.PlainIronColor( armor.ItemID ); }
					else if ( armor.Resource == CraftResource.DullCopper ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "dull copper", "", 0 ); }
					else if ( armor.Resource == CraftResource.ShadowIron ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "shadow iron", "", 0 ); }
					else if ( armor.Resource == CraftResource.Copper ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "copper", "", 0 ); }
					else if ( armor.Resource == CraftResource.Bronze ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "bronze", "", 0 ); }
					else if ( armor.Resource == CraftResource.Gold ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "gold", "", 0 ); }
					else if ( armor.Resource == CraftResource.Agapite ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "agapite", "", 0 ); }
					else if ( armor.Resource == CraftResource.Verite ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "verite", "", 0 ); }
					else if ( armor.Resource == CraftResource.Valorite ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "valorite", "", 0 ); }
					else if ( armor.Resource == CraftResource.Steel ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "steel", "", 0 ); }
					else if ( armor.Resource == CraftResource.Brass ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "brass", "", 0 ); }
					else if ( armor.Resource == CraftResource.Mithril ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "mithril", "", 0 ); }
					else if ( armor.Resource == CraftResource.Xormite ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "xormite", "", 0 ); }
					else if ( armor.Resource == CraftResource.Obsidian ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "obsidian", "", 0 ); }
					else if ( armor.Resource == CraftResource.Nepturite ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "nepturite", "", 0 ); }
					else if ( armor.Resource == CraftResource.Dwarven ){ armor.Hue = Server.Misc.MaterialInfo.GetMaterialColor( "dwarven", "", 0 ); }
				}
			}
		}
