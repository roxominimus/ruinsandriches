...
namespace Server.Misc
{
    class RelicItems
    {
		public static string IdentifyRelicValue( Mobile examiner, Mobile customer, Item item )
		{
			...
			else if ( item is DDRelicArmor ){ gold = ((DDRelicArmor)item).RelicGoldValue; buyer = "an armorer"; }
			...
			else if ( item is DDRelicBearRugsAddonDeed ){ gold = ((DDRelicBearRugsAddonDeed)item).RelicGoldValue; buyer = "a fur trader"; }
