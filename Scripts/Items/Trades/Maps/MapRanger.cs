...
namespace Server.Items 
{
	...
	public class MapRanger : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( GoToWorld == "the Island of Umber Veil" && PlayerSettings.GetDiscovered( from, "the Island of Umber Veil" ) ){ CanUseMap = true; }
			else if ( GoToWorld == "the Land of Ambrosia" && PlayerSettings.GetDiscovered( from, "the Land of Ambrosia" ) ){ CanUseMap = true; }
			else if ( GoToWorld == "the Land of Lodoria" && PlayerSettings.GetDiscovered( from, "the Land of Lodoria" ) ){ CanUseMap = true; }
			else if ( GoToWorld == "the Serpent Island" && PlayerSettings.GetDiscovered( from, "the Serpent Island" ) ){ CanUseMap = true; }
			else if ( GoToWorld == "the Isles of Dread" && PlayerSettings.GetDiscovered( from, "the Isles of Dread" ) ){ CanUseMap = true; }
			else if ( GoToWorld == "the Savaged Empire" && PlayerSettings.GetDiscovered( from, "the Savaged Empire" ) ){ CanUseMap = true; }
			else if ( GoToWorld == "the Bottle World of Kuldar" && PlayerSettings.GetDiscovered( from, "the Bottle World of Kuldar" ) ){ CanUseMap = true; }
		...
		public class SpeechGumpEntry : ContextMenuEntry
		{
			...
			public override void OnClick()
			{
				...
				PlayerMobile mobile = (PlayerMobile) m_Mobile;
				{
					...
					{
						mobile.SendGump(new SpeechGump( mobile, "Trail Map", SpeechFunctions.SpeechText( m_Mobile, m_Mobile, "TrailMap" ) ));
					}
				}
            }
        }
