...
namespace Server.Misc
{
    class MorphingItem
    {
		...
		public static SkillName GetMorphSkill( int force )
		{
			...
			else if ( force == 3 ){ skill = SkillName.Druidism; }
			else if ( force == 4 ){ skill = SkillName.Taming; }
			else if ( force == 5 ){ skill = SkillName.Marksmanship; }
			...
			else if ( force == 13 ){ skill = SkillName.Knightship; }
			else if ( force == 14 ){ skill = SkillName.Cooking; }
			else if ( force == 15 ){ skill = SkillName.Searching; }
			else if ( force == 16 ){ skill = SkillName.Discordance; }
			else if ( force == 17 ){ skill = SkillName.Psychology; }
			else if ( force == 18 ){ skill = SkillName.Fencing; }
			else if ( force == 19 ){ skill = SkillName.Seafaring; }
			else if ( force == 20 ){ skill = SkillName.Bowcraft; }
			...
			else if ( force == 44 ){ skill = SkillName.Spiritualism; }
			...
			else if ( force == 50 ){ skill = SkillName.Tasting; }
			...
			else if ( force == 54 ){ skill = SkillName.FistFighting; }
			else if ( force == 55 ){ skill = SkillName.Elementalism; }
