	...
	class ArtifactBuilder
	{
		public static Item CreateArtifact( string arty )
		{
			...
			while ( artifact == null )
			{
				...
				if ( MyServerSettings.GetUnidentifiedChance() >= Utility.RandomMinMax( 1, 100 ) && artifact != null )
				{
		...
		public static Item CreateMetalWeapon()
		{
			...
			switch ( nType )
			{
				...
				case 32:	item = new ShortSpear();		item.Name = "rapier";			break;
				...
				case 42:	item = new Claymore();			item.Name = "claymore";			break;
				case 43:	item = new SpikedClub();		item.Name = "spiked club";		break;
				case 44:	item = new Hammers();			item.Name = "hammer";			break;
				case 45:	item = new LargeKnife();		item.Name = "large knife";		break;
				case 46:	item = new ShortSword();		item.Name = "short sword";		break;
				case 47:	item = new Pitchforks();		item.Name = "pitchfork";		break;
			}
		...
		public static Item CreateWoodenArmor()
		{
			...
			switch ( Utility.RandomMinMax( 0, 7 ) ) 
			{
				...
				case 4:		item = new LeatherLegs();		item.ItemID = 0x46AA;	item.Name = "leggings";		break;
