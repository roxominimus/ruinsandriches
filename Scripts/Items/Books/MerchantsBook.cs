		...
		public static void SetupSaleBooks()
		{
			if ( MyServerSettings.MerchantBooks() )
			{
				...
				if ( item is MerchantsBook )
				{
					...
					else if ( category == "deep sea" ){ book.MarkUp = 2; book.Resource = CraftResource.SpinedLeather; }
					else if ( category == "lizard" ){ book.MarkUp = 2; book.Resource = CraftResource.HornedLeather; }
					else if ( category == "serpent" ){ book.MarkUp = 2.5; book.Resource = CraftResource.BarbedLeather; }
					else if ( category == "necrotic" ){ book.MarkUp = 2.5; book.Resource = CraftResource.NecroticLeather; }
					else if ( category == "volcanic" ){ book.MarkUp = 3; book.Resource = CraftResource.VolcanicLeather; }
