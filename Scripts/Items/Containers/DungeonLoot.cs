		...
		private static Type[] m_DungeonRareTypes = new Type[]
			{
				...
				typeof( BrokenFallenChairDeed ),	typeof( MyElementalSpellbook ),		typeof( BrokenCoveredChairDeed ),
				typeof( BrokenChestOfDrawersDeed ),										typeof( BrokenBookcaseDeed ),
				typeof( BrokenBedDeed ),		typeof( StandingBrokenChairDeed ),
				typeof( EnormousBag ),			typeof( GiantBag ),
			};
		...
		private static Type[] m_SpaceJunkTypes = new Type[]
			{
				...
				typeof( HoodedMantle ),			typeof( Robe ),						typeof( Robe ),
