...
namespace Server.Misc
{
    class MaterialInfo
    {
		...
		public static string GetResourceName( CraftResource resource )
		{
			...
			if ( resource == CraftResource.DullCopper ){ material = "dull copper"; }
			else if ( resource == CraftResource.ShadowIron ){ material = "shadow iron"; }
			else if ( resource == CraftResource.Copper ){ material = "copper"; }
			else if ( resource == CraftResource.Bronze ){ material = "bronze"; }
			else if ( resource == CraftResource.Gold ){ material = "golden"; }
			else if ( resource == CraftResource.Agapite ){ material = "agapite"; }
			else if ( resource == CraftResource.Verite ){ material = "verite"; }
			else if ( resource == CraftResource.Valorite ){ material = "valorite"; }
			else if ( resource == CraftResource.Steel ){ material = "steel"; }
			else if ( resource == CraftResource.Brass ){ material = "brass"; }
			else if ( resource == CraftResource.Mithril ){ material = "mithril"; }
			else if ( resource == CraftResource.Xormite ){ material = "xormite"; }
			else if ( resource == CraftResource.Obsidian ){ material = "obsidian"; }
			else if ( resource == CraftResource.Nepturite ){ material = "nepturite"; }
			else if ( resource == CraftResource.Dwarven ){ material = "dwarven"; }
			//else if ( resource == CraftResource.Iron ){ material = "iron"; }
			//else if ( resource == CraftResource.RegularLeather ){ material = "regular"; }
			else if ( resource == CraftResource.SpinedLeather ){ material = "deep sea"; }
			else if ( resource == CraftResource.HornedLeather ){ material = "lizard"; }
			else if ( resource == CraftResource.BarbedLeather ){ material = "serpent"; }
			else if ( resource == CraftResource.NecroticLeather ){ material = "necrotic"; }
			else if ( resource == CraftResource.VolcanicLeather ){ material = "volcanic"; }
			else if ( resource == CraftResource.FrozenLeather ){ material = "frozen"; }
			else if ( resource == CraftResource.GoliathLeather ){ material = "goliath"; }
			else if ( resource == CraftResource.DraconicLeather ){ material = "draconic"; }
			else if ( resource == CraftResource.HellishLeather ){ material = "hellish"; }
			else if ( resource == CraftResource.DinosaurLeather ){ material = "dinosaur"; }
			else if ( resource == CraftResource.AlienLeather ){ material = "alien"; }
			//else if ( resource == CraftResource.RegularWood ){ material = "wooden"; }
			else if ( resource == CraftResource.AshTree ){ material = "ash"; }
			else if ( resource == CraftResource.CherryTree ){ material = "cherry"; }
			else if ( resource == CraftResource.EbonyTree ){ material = "ebony"; }
			else if ( resource == CraftResource.GoldenOakTree ){ material = "golden oak"; }
			else if ( resource == CraftResource.HickoryTree ){ material = "hickory"; }
			else if ( resource == CraftResource.MahoganyTree ){ material = "mahogany"; }
			else if ( resource == CraftResource.OakTree ){ material = "oak"; }
			else if ( resource == CraftResource.PineTree ){ material = "pine"; }
			else if ( resource == CraftResource.RosewoodTree ){ material = "rosewood"; }
			else if ( resource == CraftResource.DriftwoodTree ){ material = "driftwood"; }
			else if ( resource == CraftResource.WalnutTree ){ material = "walnut"; }
			else if ( resource == CraftResource.ElvenTree ){ material = "elven"; }
			else if ( resource == CraftResource.GhostTree ){ material = "ghostwood"; }
			else if ( resource == CraftResource.PetrifiedTree ){ material = "petrified"; }
		...
		{
			if ( item.ItemID == 0x646C || item.ItemID == 0x5C14 || item.ItemID == 0x4D09 || item.ItemID == 0x141B || item.ItemID == 0x141C || item.ItemID == 0x4D01 || item.ItemID == 0x4D02 || item.ItemID == 0x4D03 || item.ItemID == 0x4D04 || item.ItemID == 0x3176 || item.ItemID == 0x3177 || item.ItemID == 0x2B71 || item.ItemID == 0x3168 || item.ItemID == 0x4CDA || item.ItemID == 0x4CDB || item.ItemID == 0x4CDC || item.ItemID == 0x4CDD )
				return true;
		...
		public static void ColorPlainWood( Item item )
		{
			switch ( Utility.RandomMinMax( 0, 14 ) ) 
			{
				...
				case 2: item.Hue = MaterialInfo.GetMaterialColor( "cherry", "", 0 );	break;
				case 3: item.Hue = MaterialInfo.GetMaterialColor( "ebony", "", 0 );	break;
				case 4: item.Hue = MaterialInfo.GetMaterialColor( "golden oak", "", 0 );	break;
				case 5: item.Hue = MaterialInfo.GetMaterialColor( "hickory", "", 0 );	break;
				case 6: item.Hue = MaterialInfo.GetMaterialColor( "mahogany", "", 0 );	break;
				case 7: item.Hue = MaterialInfo.GetMaterialColor( "oak", "", 0 );	break;
				case 8: item.Hue = MaterialInfo.GetMaterialColor( "pine", "", 0 );	break;
				case 9: item.Hue = MaterialInfo.GetMaterialColor( "ghostwood", "", 0 );	break;
				case 10: item.Hue = MaterialInfo.GetMaterialColor( "rosewood", "", 0 );	break;
				case 11: item.Hue = MaterialInfo.GetMaterialColor( "walnut", "", 0 );	break;
				case 12: item.Hue = MaterialInfo.GetMaterialColor( "petrified", "", 0 );	break;
				case 13: item.Hue = MaterialInfo.GetMaterialColor( "driftwood", "", 0 );	break;
				case 14: item.Hue = MaterialInfo.GetMaterialColor( "elven", "", 0 );	break;
			}
		}
		...
		public static int GetSpaceAceColors( string item )
		{
			...
			else if ( item == "Titanium" ){ color = 0xB70; }
			...
			else if ( item == "Farium" ){ color = 0x775; }
			else if ( item == "Trimantium" ){ color = 0x8C3; }
			...
			else if ( item == "Cerlin" ){ color = 0xB57; }
			...
			else if ( item == "Thermoweave" ){ color = 0x775; }
			...
			else if ( item == "Borl" ){ color = 0x775; }
			else if ( item == "Japor" ){ color = 0x948; }
			...
			else if ( item == "Tusken" ){ color = 0x775; }
			else if ( item == "Andorian" ){ color = 0xB3D; }
		...
		public static int GetMaterialColor( string color, string style, int based )
		{
			...
			else if ( style == "obsolete" )
			{
				...
				else if ( color == "copper" ){ hue = 0x8BD; }
			...
			{
				if ( color == "agapite" ){ hue = 0x7BC; }
				else if ( color == "brass" ){ hue = 0xB1B; }
				else if ( color == "bronze" ){ hue = 0x7B7; }
				else if ( color == "copper" ){ hue = 0x776; }
				else if ( color == "dull copper" ){ hue = 0x830; }
				else if ( color == "dwarven" ){ hue = 0x97F; }
				else if ( color == "gold" ){ hue = 0x82B; }
				else if ( color == "mithril" ){ hue = 0x8D7; }
				else if ( color == "nepturite" ){ hue = 0x825; }
				else if ( color == "obsidian" ){ hue = 0x7C2; }
				else if ( color == "shadow iron" ){ hue = 0x877; }
				else if ( color == "steel" ){ hue = 0x994; }
				else if ( color == "valorite" ){ hue = 0xB0A; }
				else if ( color == "verite" ){ hue = 0x77E; }
				else if ( color == "xormite" ){ hue = 0x7C7; }
				else if ( color == "jade" ){ hue = 0xB0C; }
				else if ( color == "marble" ){ hue = 0xB3B; }
				else if ( color == "onyx" ){ hue = 0xB5E; }
				...
				else if ( color == "silver" ){ hue = 0x56A; }
			}
		...
		public static void ConvertMaterial( Item item )
		{
			...
			if ( MyServerSettings.ShinyArmor() && !(item is BaseGranite) && !(item is Container) ) // NEWER COLORS
			{
				...
				{
					if ( item.Hue == GetMaterialColor( "agapite", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "agapite", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "brass", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "brass", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "bronze", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "bronze", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "copper", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "copper", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "dull copper", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "dull copper", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "dwarven", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "dwarven", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "gold", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "gold", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "mithril", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "mithril", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "nepturite", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "nepturite", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "obsidian", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "obsidian", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "shadow iron", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "shadow iron", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "steel", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "steel", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "valorite", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "valorite", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "verite", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "verite", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "xormite", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "xormite", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "jade", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "jade", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "marble", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "marble", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "onyx", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "onyx", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "quartz", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "quartz", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "ruby", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "ruby", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "sapphire", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "sapphire", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "spinel", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "spinel", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "star ruby", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "star ruby", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "topaz", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "topaz", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "amethyst", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "amethyst", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "caddellite", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "caddellite", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "emerald", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "emerald", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "garnet", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "garnet", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "ice", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "ice", "alter", 99999 ); }
					else if ( item.Hue == GetMaterialColor( "silver", "alter", 99997 ) ){ item.Hue = GetMaterialColor( "silver", "alter", 99999 ); }
				}
			}
