...
namespace Server.SkillHandlers
{
	public class Taming
	{
		...
		public static bool CheckMastery( Mobile tamer, BaseCreature creature )
		{
			...
			{
				if ( creature is Worg || creature is WolfDire || creature is DireWolf || creature is GreyWolf || creature is TimberWolf || creature is WhiteWolf || creature is MysticalFox )
					return true;
			}
