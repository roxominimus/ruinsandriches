    ...
    class FishingQuestFunctions
    {
		...
		public static void FindTarget( Mobile m, int fee )
		{
			...
			switch ( WorldPick )
			{
				...
				case 6:		searchLocation = "the Isles of Dread";			if ( !( PlayerSettings.GetDiscovered( m, "the Isles of Dread" ) ) ){ searchLocation = "the Land of Sosaria"; } break;
				...
				case 9:		searchLocation = "the Serpent Island";			if ( !( PlayerSettings.GetDiscovered( m, "the Serpent Island" ) ) ){ searchLocation = "the Land of Sosaria"; } break;
