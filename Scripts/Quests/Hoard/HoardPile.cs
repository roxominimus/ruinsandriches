			...
			else if ( m_Uses < 5 )
			{
				...
				switch ( Utility.Random( 17 ) )
				{
					...
					case 4:
						...
						if ( item is UnusualDyes && Server.Misc.GetPlayerInfo.EvilPlay( from ) ){ item.Hue = Utility.RandomEvilHue(); }
						break;
					case 5:
					...
					case 8: case 9: case 10: case 11:
						item = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing( Server.LootPackEntry.IsInIslesDread( from ) );
						item = ContainerFunctions.LootMutate( from, Server.LootPack.GetRegularLuckChance( from ), item, from.Backpack, Utility.RandomMinMax( 5, 10 ) );
						break;
					case 12:
