	...
	public class RSCloth: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SoldResource() )
				{
					Add( new GenericBuyInfo( typeof( UncutCloth ), 3, Utility.Random( 100,950 ), 0x1765, Utility.RandomDyedHue() ) );
					Add( new GenericBuyInfo( typeof( BoltOfCloth ), 100, Utility.Random( 100,950 ), 0xF95, Utility.RandomDyedHue() ) );
				}
				else
				{
					Add( new GenericBuyInfo( typeof( UncutCloth ), 3, Utility.Random( 4,60 ), 0x1765, Utility.RandomDyedHue() ) );
					Add( new GenericBuyInfo( typeof( BoltOfCloth ), 100, Utility.Random( 4,60 ), 0xF95, Utility.RandomDyedHue() ) );
				}
			}
		}
	...
	public class SBTailor: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Cloth ), 2, Utility.Random( 1,15 ), 0x175D, Utility.RandomDyedHue() ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( UncutCloth ), 2, Utility.Random( 1,15 ), 0x1765, Utility.RandomDyedHue() ) ); } 
	...
	public class SBTailorGuild: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( Cloth ), 2, Utility.Random( 3,31 ), 0x175D, Utility.RandomDyedHue() ) ); 
				Add( new GenericBuyInfo( typeof( UncutCloth ), 2, Utility.Random( 3,31 ), 0x1765, Utility.RandomDyedHue() ) ); 
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{
				...
				Add( new GenericBuyInfo( typeof( RoyalShield ), 231, Utility.Random( 1,15 ), 0x2B01, 0 ) );
				Add( new GenericBuyInfo( typeof( RoyalHelm ), 21, Utility.Random( 1,15 ), 0x2B10, 0 ) );
				Add( new GenericBuyInfo( typeof( RoyalGorget ), 104, Utility.Random( 1,15 ), 0x2B0E, 0 ) );
				Add( new GenericBuyInfo( typeof( RoyalChest ), 243, Utility.Random( 1,15 ), 0x2B08, 0 ) );
				Add( new GenericBuyInfo( typeof( RoyalsLegs ), 218, Utility.Random( 1,15 ), 0x2B06, 0 ) );
				Add( new GenericBuyInfo( typeof( RoyalArms ), 188, Utility.Random( 1,15 ), 0x2B12, 0 ) );
				Add( new GenericBuyInfo( typeof( RoyalGloves ), 155, Utility.Random( 1,15 ), 0x2B0C, 0 ) );
				Add( new GenericBuyInfo( typeof( RoyalBoots ), 104, Utility.Random( 1,15 ), 0x2B12, 0 ) );
		...
		{ 
			public InternalSellInfo() 
			{
				...
				Add( typeof( RoyalShield ), 115 );
				Add( typeof( RoyalHelm ), 10 );
				Add( typeof( RoyalArms ), 94 );
				Add( typeof( RoyalChest ), 121 );
				Add( typeof( RoyalGloves ), 72 );
				Add( typeof( RoyalGorget ), 52 );
				Add( typeof( RoyalsLegs ), 109 );
				Add( typeof( RoyalBoots ), 94 );
