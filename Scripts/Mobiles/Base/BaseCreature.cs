	...
	public class BaseCreature : Mobile, IHonorTarget
	{
		...
		*/
		...
		public virtual void OnThink()
		{
			...
			else if ( Server.Misc.MyServerSettings.LineOfSight( this, false ) && !Controlled && Combatant == null && WhisperHue != 999 && WhisperHue != 666 ) // MOVE FROM PLAYER SIGHT WHEN NOT SEEN
			{
				bool seeing = true;
