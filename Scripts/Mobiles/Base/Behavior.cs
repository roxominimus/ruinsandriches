...
namespace Server.Misc
{
    class IntelligentAction
    {
		...
		public static void DressUpMerchants( Mobile from )
		{
			...
			else if ( from is NecroMage ){ 				hasRobe = true;		robeHue = MorphingTime.GetRandomNecromancerHue();	wizard = true;	}
