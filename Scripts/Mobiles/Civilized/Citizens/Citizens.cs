	...
	public class Citizens : BaseCreature
	{
		...
		public static void PopulateCities()
		{
			...
			for ( int i = 0; i < meetingPets.Count; ++i )
			{
				...
				if ( Server.Misc.MyServerSettings.Humanoid() ){ CreatePets( spot ); }
			}
			...
			else if ( !(m is HouseVisitor ) )
			{
				...
				switch ( Utility.Random( 30 ) )
				{
					...
					case 8: roll = Utility.RandomMinMax( 1, 5 );
						...
						break;
					case 9:
						roll = 0; if ( !Server.Misc.MyServerSettings.AllowZebras() ){ roll = 1; }
		...
		public override bool OnDragDrop( Mobile from, Item dropped )
		{
			...
			else if ( CitizenType == 1 )
			{
				if ( CitizenType == 1 && dropped is BaseMagicStaff )
				{
					...
					else if ( bw.IntRequirement < 1 ){ say = "That does not need to be recharged."; }
